...
formPesquisa.addEventListener('submit', function (event) {
  ...
  const autor = document.getElementById('autor')?.value || 'Jogador';
...
// === NOVA FUNÇÃO PARA NAVEGAR ENTRE ABAS ===
function mostrarAba(qual) {
  ...
  fase2.style.display = 'none';
  pesquisa.style.display = 'none';
  document.getElementById('aba-autor').style.display = 'none';
  document.getElementById('aba-funcionamento').style.display = 'none';
  ...
  if (qual === 'inicio') {
    ...
    document.getElementById('aba-autor').style.display = 'block';
  } else if (qual === 'funcionamento') {
    document.getElementById('aba-funcionamento').style.display = 'block';
  }
}
